                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40" id="add-supplier-form" method="post" action="/product">
                                    {{csrf_field()}}
                                    {{--supplier name--}}
                                    <div class="form-group">
                                        <label for="product_code"><span class="help"><strong>Product Code</strong></span></label>
                                        <input type="text" class="form-control form-control-line" placeholder="" name="product_code">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-line" placeholder="" name="product_name">
                                    </div>
