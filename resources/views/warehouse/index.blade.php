            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h3 class="text-themecolor">Warehouse List <span class="pull-right"><a href="/warehouse/create"><button class="btn btn-info">Add New Warehouse</button></a></span></h3>
                        <ol class="breadcrumb">
                                    ...
                                    <table id="example23" class=" text-center display nowrap table table-hover table-striped table-bordered">
                                        ...
                                        @foreach($warehouses as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-primary btn-xs"><a href="/warehouse//edit">EDIT</a></button>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
