    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                            ...
                            <div class="card-body">
                                <div class="d-flex p-10 no-block">
                                    <div class="align-slef-center">
                                        <h2 class="m-b-0">{!! $total_supplier !!}</h2>
                                        <h6 class="text-muted m-b-0">Suppliers</h6>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex p-10 no-block">
                                    <div class="align-slef-center">
                                        <h2 class="m-b-0">{!! $weekly_sales !!} BDT</h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex p-10 no-block">
                                    <div class="align-slef-center">
                                        <h2 class="m-b-0">{!! $monthly_sales !!} BDT</h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex p-10 no-block">
                                    <div class="align-slef-center">
                                        <h2 class="m-b-0">{!! $showroom !!}</h2>
                                        <h6 class="text-muted m-b-0">Total Showroom</h6>
                                    </div>
                ...
                <!-- ============================================================== -->
                <!-- ============================================================== -->
                <!-- Over Visitor, Our income , slaes different and  sale prediction -->
                <!-- ============================================================== -->
                <div class="row">
                    <!-- Column -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    <h5 class="card-title m-b-0 align-self-center">Day to Day Sales</h5>
                                </div>
                                <table class="table table-sm table-bordered text-center color-table primary-table table-condensed table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($dodsales as $row)
                                            @php 
                                            
                                                $quantity += $row['quantity'];$taka += $row['taka'];
                                        ...
                                        <tr class="text-primary table-warning">
                                            <td></td>
                                            <td>{!! $quantity !!}</td>
                                            <td>{!! $taka !!}</td>
                                            <td>100%</td>
