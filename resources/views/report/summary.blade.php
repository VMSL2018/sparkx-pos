            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Daily Sale's Summary Report</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Daily  Sale's Summary Report - @php echo isset($_GET['year']) != null ? $_GET['year'] : date('Y'); @endphp </h4>
                                ...
                                <table id="salesreport" class="display table table-hover table-striped table-bordered table-sm text-center" style="overflow:hidden !important">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($row['quantity']!= 0)
                                                        {{ round($row['total']/$row['quantity'],2) }}
                                                    @endif
                                                </td>
                                                <td>
