            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Employee Sale's Report</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Employee Sale's Report - @php echo isset($_GET['year']) != null ? $_GET['year'] : date('Y'); @endphp </h4>
