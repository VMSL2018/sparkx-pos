            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <li class="nav-item dropdown u-pro">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="/assets/images/users/9.jpg" alt="user" class="" />
                        ...
                        <ul class="dropdown-user">
                            <li>
                                <div class="dw-user-box">
                                    <div class="u-img"><img src="/assets/images/users/9.jpg" alt="user"></div>
                                    <div class="u-text">
                                        <h4>{{ Auth::user()->name }} <span class="caret"></span></h4>
                                        <p class="text-muted">{{ Auth::user()->email }} <span class="caret"></span></p>

                                        @if(Auth::user()->type == 1)
                                            <p class="text-muted">Super Admin<span class="caret"></span></p>
                                        @endif
                                        @if(Auth::user()->type == 2)
                                            <p class="text-muted">Admin<span class="caret"></span></p>
                                        @endif
                                        @if(Auth::user()->type == 3)
                                            <p class="text-muted">Cash Counter Man<span class="caret"></span></p>
                                        @endif
                                    </div>
                                </div>
                            </li>
